...
public class IOUContract implements Contract {
    ...
    public void verify(LedgerTransaction tx) {
        ...
        requireThat(require -> {
            ...
            require.using("The creator and the follower cannot be the same entity.",
                    !out.getCreator().equals(out.getFollower()));
            ...
            require.using("The IOU's key must be non-empty.",
                    !out.getKey().equals(""));
