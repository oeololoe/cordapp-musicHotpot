...
public class IOUFlow {
    ...
    public static class Initiator extends FlowLogic<SignedTransaction> {
        ...
        public Initiator(String iouValue, Party otherParty) {
        ...
        public SignedTransaction call() throws FlowException {
            ...
            final Command<IOUContract.Commands.Create> txCommand = new Command<>(
                    ...
                    ImmutableList.of(iouState.getCreator().getOwningKey(), iouState.getFollower().getOwningKey()));
            ...
            class SignTxFlow extends SignTransactionFlow {
                ...
                protected void checkTransaction(SignedTransaction stx) {
                    requireThat(require -> {
                        ...
                        require.using("I won't accept IOUs with a value over 100.", iou.getKey().length() <= 100);
                        return null;
                    });
                }
            }
