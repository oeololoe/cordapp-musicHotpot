...
public class IOUFlowTests {
    ...
    public void flowRejectsInvalidIOUs() throws Exception {
        ...
        IOUFlow.Initiator flow = new IOUFlow.Initiator(null, b.getInfo().getLegalIdentities().get(0));
    ...
    public void recordedTransactionHasNoInputsAndASingleOutputTheInputIOU() throws Exception {
        ...
        for (StartedMockNode node : ImmutableList.of(a, b)) {
            ...
            assertEquals(recordedState.getKey(), iouValue);
            assertEquals(recordedState.getCreator(), a.getInfo().getLegalIdentities().get(0));
            assertEquals(recordedState.getFollower(), b.getInfo().getLegalIdentities().get(0));
        }
    }
